...
let s1_done = `
<h2>您已完成事前預約！​</h2>
<span>記得隨時關注 <a href="https://www.facebook.com/DiGeamCabal/">粉絲團</a>，掌握遊戲第一手消息。<span>
`
...
<h2>您已完成活動，記得按讚<a href="https://www.facebook.com/DiGeamCabal/">粉絲團</a><br>掌握第一手開獎資訊！</h2>`
...
$('.pop').on("click", function () {
  ...
  if (pop == 1) {
    ...
    $('.pop_b_wrap').html(`<h2>憤怒藥水(大) x 50​</h2>
    ...
    <ul>
        ...
        <li>
            2.每個帳號只能參與一次活動並獲得一次獎勵。獎勵將於正式開服後一周內透過官網領獎專區發放。
        </li>
        <li>
            3.留言內容一經送出後即無法修改。
        </li>
        <li>
            4.實體獎勵將於每周五於粉絲專頁公布得獎名單。得獎名單公布後，受獎者須於七日內依相關法規填寫機會中獎憑證並回傳客服中心，否則視同放棄得獎資格。
        </li>
        <li>
