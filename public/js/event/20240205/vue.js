...
Vue.createApp({
    ...
    methods: {
        ...
        openModal(modalData) {
          ...
          2. 活動期間內，每日遊戲累積登入時間達30分鐘，即可點擊『祈求庇佑』領取登入獎勵，並隨機獲得一張契約小舖優惠券，每日限領一次。​​<br>
          3. 登入時間滿30分鐘後，需先重新登入遊戲/切換頻道系統才會更新在線時間，並開放領取獎勵。（伺服器更新最長需要10分鐘，若當下未能領取獎勵請稍後再次嘗試）​​<br>
          ...
          <span>※ 提醒您，伺服器更新在線時間最長需要10分鐘。請盡量避免於換日前進行『祈求庇佑』活動，以致獎勵無法及時領取。</span>`;
                ...
                this.popXL.wrapText = `
          1. 各帳號登入獎勵不限伺服器每日限領一次，若已在黑恆星伺服器累積登入達30分鐘並領取獎勵，即使使用冰珀星伺服器角色累積登入達指定時數，仍無法再次領取登入獎勵。​<br>
          ...
          10. 玩家參與本活動之同時，即同意接受本活動辦法與注意事項之規範，如不同意或有違反，應視為無參加資格 ，或本公司得取消其使用資格，如因此有致生損害於本公司或其他任何第三人，本公司得向參加者請求損害賠償，參加者應負一切相關責任。​​<br>
        ...
        blessClick() {
            ...
            if( this.logIn.finished == true){
                ...
                this.popS.popBut1 = false;
                this.popS.titleText = "您是否要花費【30黑魂】領取加倍祝福？";
                this.popS.wrapText = "";
