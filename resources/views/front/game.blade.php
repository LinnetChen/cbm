...
@section('link')
<link rel="stylesheet" href="/css/home_page/game_style.css">
@endsection
@section('main_btn')
<div class="main_btn">
...
<div class="content_box">
    <div class="btn_box">
        <a href=""><button class="btn_download">官網下載</button></a>
        <a href=""><button class="btn_download">Google下載</button></a>
    </div>
    <div class="title">推薦配置</div>
    <div class="title_line"></div>
    <div class="text_box">
        <p>1.點擊上方連結，選擇任何一個載點下載即可。</p>
        <p>2.安裝前，請確認硬碟內的空間有大於5GB。</p>
        <p>3.若下載或安裝有發生任何問題，請透過客服中心聯絡我們。</p>
        <p>4.文件大小：下載器(700KB) / 免安裝檔(487MB)</p>
        <p>5.版本發佈時間：2022/12/16</p>
        <p>6.為避免異常，請玩家安裝路徑優先採用英文數字組合 (避免中文)</p>
    </div>
    <table>
        <tr class="tab_head">
