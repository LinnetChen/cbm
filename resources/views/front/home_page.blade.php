    ...
    <div class="job_mainbox  active" id="job_box1">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">狂劍士先天就具備強壯的體格，崇尚強大的力量而不是技巧與速度，鍛鍊目標是為了徹底掌控身體，因此不需要培養魔力的理解能力，每次攻擊都帶來極強的破壞力，讓敵人不得不退避三舍。</div>
    ...
    <div class="job_mainbox" id="job_box2">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">雙劍士追求精湛的技巧與敏捷的速度，有著超乎常人的反應能力，利用極高的敏捷特性在戰場上迅速穿梭，極快的速度讓他們能夠產生分身幻象擾亂敵人視線，讓敵人難以抓住他的身影，創造絕佳的攻擊機會。</div>
                <div class="job_info animate__animated animate__fadeInDown">
    ...
    <div class="job_mainbox" id="job_box3">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">盾劍士渴望極強的防禦能力，不滿足於穿戴防禦力較高的重型盔甲，他們嘗試將魔力運用在防禦上，讓武器轉變為星之盾，開創出新的魔力運用方式。成為擁有絕對防禦能力的戰士。</div>
                <div class="job_info animate__animated animate__fadeInDown">
    ...
    <div class="job_mainbox" id="job_box4">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">魔劍士在一次次研究中，成功將魔法與劍術結合，發展出高超的戰鬥方式，每次攻擊帶來強大的破壞力，但由於需要同時使用兩種戰鬥方式的力量，因此在培養訓練上需要花費較多心力。</div>
                <div class="job_info animate__animated animate__fadeInDown">
    ...
    <div class="job_mainbox" id="job_box5">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">角鬥士有著與生俱來的戰鬥本能，透過控制對敵人產生的憤怒情緒，來激發自身的戰鬥能力。為了能夠最大程度的運用飛輪施展技能，同時負擔盔甲重量，他們需要不斷的磨練自身的力量和靈活性來達成目的。</div>
                <div class="job_info animate__animated animate__fadeInDown">
    ...
    <div class="job_mainbox" id="job_box6">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">魔導師是掌握著魔法、爆發力和超級強大破壞力的絕對強者。他們可以隨心所欲地操控體內魔力與自然之力共鳴，甚至於同時施展多種魔法，將其化為毀滅性的魔法攻擊，破壞力足以令敵人望而生畏。</div>
                <div class="job_info animate__animated animate__fadeInDown">
    ...
    <div class="job_mainbox" id="job_box7">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">弓箭手起源於魔導師，將魔力轉化為箭矢造成巨大的破壞力，而靈活性是他們最大的優勢之一，在戰場上輕鬆改變位置和躲避敵人的攻擊，憑藉著靈活的身手和卓越的射擊技巧，強大的遠程支援成為戰場上勝利的關鍵。</div>
                <div class="job_info animate__animated animate__fadeInDown">
    ...
    <div class="job_mainbox" id="job_box8">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">銃槍手繼承了賢者之塔秘密部隊的戰鬥模式，將武器轉變為槍械的多種型態，訓練著重於提高準確度和快速反應能力，使得他們能夠在高壓環境下保持冷靜，以精準的射擊給予敵人致命的打擊，成為了遠距離射擊專家。</div>
                <div class="job_info animate__animated animate__fadeInDown">
    ...
    <div class="job_mainbox" id="job_box9">
        <div class="job_box">
            ...
            <div class="job_right">
                ...
                <div class="job_text animate__animated animate__fadeInDown" data-aos="fade-up">咒術師行為舉止透露出神秘和邪惡的氛圍，他們通過將魔力與靈魂結合，形成強大的禁忌力量來提升自己的魔力，擅長施展恐怖且極具摧毀力的黑暗魔法，對敵人造成極大的破壞和混亂，成為戰場上讓敵人心生畏懼的存在。</div>
                <div class="job_info animate__animated animate__fadeInDown">
