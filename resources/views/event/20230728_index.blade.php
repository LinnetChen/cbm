...
<body>
        ...
        <div class="main">
            <div class="toppage">
                <div class="topBG">
                    ...
                    <a href="#idol" class="startbtn"></a>
                </div>
            </div>
            <div class="page2" id="starttochange">
                <div class="mainpic" id="idol">
                </div>
                <div class="stepBox1">
    ...
    <script src="js/event/20230728/view.js?v2.1"></script>
    <script src="js/event/20230728/login.js?v2.1"></script>
    <script src="js/event/20230728/main.js?v2.1"></script>
